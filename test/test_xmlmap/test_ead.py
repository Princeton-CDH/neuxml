...
class TestEad(unittest.TestCase):
    ...
    def test_basic_fields(self):
        ...
        self.assertTrue("materials relating to Irish poet Seamus Heaney" in str(self.ead.abstract))
    ...
    def test_ArchivalDescription(self):
        ...
        self.assertTrue("Special restrictions apply" in str(ad.access_restriction.content[0]))
        self.assertTrue(isinstance(ad.use_restriction, eadmap.Section))
        self.assertEqual("Terms Governing Use and Reproduction", str(ad.use_restriction.head))
        self.assertTrue("limitations noted in departmental policies" in str(ad.use_restriction.content[0]))
        ...
        self.assertEqual("Related Materials in This Repository", str(ad.related_material.head))
        ...
        self.assertEqual("Related Materials in This Repository", str(ad.separated_material.head))
        self.assertTrue("Ciaran Carson papers, Peter Fallon" in str(ad.separated_material.content[0]))
        self.assertTrue(isinstance(ad.acquisition_info, eadmap.Section))
        self.assertEqual("Source", str(ad.acquisition_info.head))
        self.assertTrue("Collection assembled from various sources." in str(ad.acquisition_info.content[0]))
        ...
        self.assertTrue("Originally received as part of" in str(ad.custodial_history.content[0]))
        self.assertTrue(isinstance(ad.preferred_citation, eadmap.Section))
        self.assertEqual("Citation", str(ad.preferred_citation.head))
        self.assertTrue("[after identification of item(s)" in str(ad.preferred_citation.content[0]))
        ...
        self.assertTrue("consists of materials relating" in str(ad.scope_content.content[0]))
    ...
    def test_index_indexentry(self):
        ...
        self.assertTrue('relates to the correspondence in Series 1' in str(index.note.content[0]))
    ...
    def test_unittitle(self):
        ...
        self.assertEqual('Writings by Seamus Heaney',
                         str(self.ead.dsc.c[0].did.unittitle.short))
