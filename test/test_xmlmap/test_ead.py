...
class TestEad(unittest.TestCase):
    ...
    def test_basic_fields(self):
        ...
        self.assertTrue("Seamus Heaney collection," in u(self.ead.unittitle))
        self.assertTrue("1972-2005" in u(self.ead.unittitle))
    ...
    def test_ArchivalDescription(self):
        ...
        self.assertTrue("Special restrictions apply" in u(ad.access_restriction.content[0]))
        ...
        self.assertTrue("limitations noted in departmental policies" in u(ad.use_restriction.content[0]))
        self.assertTrue(isinstance(ad.alternate_form, eadmap.Section))
        self.assertEqual("Publication Note", u(ad.alternate_form.head))
        self.assertTrue("Published in" in u(ad.alternate_form.content[0]))
        ...
        self.assertTrue("Suppressed chapter" in u(ad.originals_location.content[0]))
        ...
        self.assertTrue("part of MSS" in u(ad.related_material.content[0]))
        ...
        self.assertTrue("Ciaran Carson papers, Peter Fallon" in u(ad.separated_material.content[0]))
        self.assertTrue(isinstance(ad.acquisition_info, eadmap.Section))
        self.assertEqual("Source", u(ad.acquisition_info.head))
        self.assertTrue("Collection assembled from various sources." in u(ad.acquisition_info.content[0]))
        ...
        self.assertTrue("Originally received as part of" in u(ad.custodial_history.content[0]))
        self.assertTrue(isinstance(ad.preferred_citation, eadmap.Section))
        self.assertEqual("Citation", u(ad.preferred_citation.head))
        self.assertTrue("[after identification of item(s)" in u(ad.preferred_citation.content[0]))
        ...
        self.assertTrue("born on April 13" in u(ad.biography_history.content[0]))
        self.assertTrue("While at St. Joseph's" in u(ad.biography_history.content[1]))
        self.assertTrue(isinstance(ad.bibliography, eadmap.Section))
        self.assertEqual("Publication Note", u(ad.bibliography.head))
        self.assertTrue("Susan Jenkins Brown" in u(ad.bibliography.content[0]))
    ...
    def test_index_indexentry(self):
        ...
        self.assertTrue('relates to the correspondence in Series 1' in u(index.note.content[0]))
        ...
        self.assertTrue('1995 July' in u(index.entry[0].ptrgroup.ref[0].value))
        self.assertEqual('Belton, Neil', u(index.entry[1].name))
        self.assertTrue('1993 November 3' in u(index.entry[1].ptrgroup.ref[-1].value))
    ...
    def test_ControlledAccessHeadings(self):
        ...
        self.assertTrue(isinstance(ca.controlaccess[0], eadmap.ControlledAccessHeadings))
        ...
        self.assertTrue(isinstance(ca.controlaccess[5].corporate_name[0], eadmap.Heading))
    ...
    def test_SubordinateComponents(self):
        ...
        self.assertTrue("holograph manuscript" in u(dsc.c[0].c[0].did.unittitle))
        ...
        self.assertTrue("Hilary Boyle" in u(dsc.c[1].c[0].c[0].did.unittitle))
