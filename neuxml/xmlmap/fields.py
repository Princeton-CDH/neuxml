...
class Field(object):
    ...
    def __init__(
        self, xpath, manager, mapper, required=None, verbose_name=None, help_text=None
    ):
    ...
    def get_for_node(self, node, context):
        return self.manager.get(
            self.xpath, node, context, self.mapper, self.parsed_xpath
        )

    def set_for_node(self, node, context, value):
        return self.manager.set(
            self.xpath, self.parsed_xpath, node, context, self.mapper, value
        )

    def delete_for_node(self, node, context):
        return self.manager.delete(
            self.xpath, self.parsed_xpath, node, context, self.mapper
        )
...
class SimpleBooleanMapper(Mapper):
    ...
    def to_python(self, node):
        ...
        raise Exception(
            "Boolean field value '%s' is neither '%s' nor '%s'"
...
def _predicate_is_constructible(pred):
    if isinstance(pred, ast.Step):
        ...
        if any(
            (not _predicate_is_constructible(sub_pred) for sub_pred in pred.predicates)
        ):
            return False
        ...
        if pred.op == "/":
            ...
            if not _predicate_is_constructible(pred.left):
                return False
            if not isinstance(pred.right, (int, str, ast.VariableReference)):
                return False
    ...
    # (other than any predicates defined in the xpath), remove them as well.
        ...
        if xast.op == "/":
            ...
            if left_node is not None:
                ...
                removed = _remove_xml(
                    xast.right, left_node, context, if_empty=if_empty
                )  # honor current if_empty flag
...
def _remove_predicates(xast, node, context):
    ...
    for pred in list(xast_c.predicates):
        ...
        if isinstance(pred, ast.BinaryExpression):
            ...
            if pred.op == "=" and node.xpath(serialize(pred), **context) is True:
    ...
    def set(self, xpath, xast, node, context, mapper, value):
        ...
        if xvalue is None:
            ...
            if match is not None:
                ...
                if not removed:
                    logger.warn(
                        """Could not remove xml for '%s' from %r"""
                        % (serialize(xast), node)
                    )
        else:
            if match is None:
    ...
    **in**; equal and not equal comparison to standard python Lists.  Items can
    ...
    def insert(self, i, x):
        ...
        if i == len(self):  # end of list or empty list: append
            ...
            raise IndexError(
                "Can't insert '%s' at index %d - list length is only %d"
                % (x, i, len(self))
            )
...
class StringListField(Field):
    ...
    def __init__(self, xpath, normalize=False, choices=None, *args, **kwargs):
        self.choices = choices
        super(StringListField, self).__init__(
            xpath,
...
class FloatField(Field):
    ...
    def __init__(self, xpath, *args, **kwargs):
        super(FloatField, self).__init__(
            xpath, manager=SingleNodeManager(), mapper=FloatMapper(), *args, **kwargs
        )
...
class FloatListField(Field):
    ...
    def __init__(self, xpath, *args, **kwargs):
        super(FloatListField, self).__init__(
            xpath, manager=NodeListManager(), mapper=FloatMapper(), *args, **kwargs
        )
...
class IntegerField(Field):
    ...
    def __init__(self, xpath, *args, **kwargs):
        super(IntegerField, self).__init__(
            xpath, manager=SingleNodeManager(), mapper=IntegerMapper(), *args, **kwargs
        )
...
class IntegerListField(Field):
    ...
    def __init__(self, xpath, *args, **kwargs):
        super(IntegerListField, self).__init__(
            xpath, manager=NodeListManager(), mapper=IntegerMapper(), *args, **kwargs
        )
...
class SimpleBooleanField(Field):
    ...
    def __init__(self, xpath, true, false, *args, **kwargs):
        super(SimpleBooleanField, self).__init__(
            xpath,
            manager=SingleNodeManager(),
...
class DateTimeField(Field):
    ...
    def __init__(self, xpath, format=None, normalize=False, *args, **kwargs):
        super(DateTimeField, self).__init__(
            xpath,
            manager=SingleNodeManager(),
            mapper=DateTimeMapper(format=format, normalize=normalize),
            *args,
            **kwargs,
        )
...
class DateTimeListField(Field):
    ...
    def __init__(self, xpath, format=None, normalize=False, *args, **kwargs):
        super(DateTimeListField, self).__init__(
            xpath,
            manager=NodeListManager(),
            mapper=DateTimeMapper(format=format, normalize=normalize),
            *args,
...
class DateField(Field):
    ...
    def __init__(self, xpath, format=None, normalize=False, *args, **kwargs):
        super(DateField, self).__init__(
            xpath,
            manager=SingleNodeManager(),
            mapper=DateMapper(format=format, normalize=normalize),
            *args,
            **kwargs,
        )
...
class DateListField(Field):
    ...
    def __init__(self, xpath, format=None, normalize=False, *args, **kwargs):
        super(DateListField, self).__init__(
            xpath,
            manager=NodeListManager(),
            mapper=DateMapper(format=format, normalize=normalize),
            *args,
...
class NodeListField(Field):
    ...
    def __init__(self, xpath, node_class, *args, **kwargs):
        super(NodeListField, self).__init__(
            xpath,
            manager=NodeListManager(),
            mapper=NodeMapper(node_class),
            *args,
...
class ItemField(Field):
    ...
    def __init__(self, xpath, *args, **kwargs):
        super(ItemField, self).__init__(
            xpath, manager=SingleNodeManager(), mapper=NullMapper(), *args, **kwargs
        )
    ...
    **replaced** with the appropriate :class:`neuxml.xmlmap.fields.Field` type
    ...
    def __init__(self, xpath, schema_type, *args, **kwargs):
        ...
        super(SchemaField, self).__init__(
            xpath, manager=None, mapper=None, *args, **kwargs
        )
    ...
    def get_field(self, schema):
        ...
        if basetype == "string":
            ...
            raise Exception(
                "basetype %s is not yet supported by SchemaField" % basetype
            )
